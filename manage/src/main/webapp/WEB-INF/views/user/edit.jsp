                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="loginName" class="form-control" placeholder="登陆名" readonly="${contentModel.loginName != null}"/><br/>
                                 <form:errors path="loginName" class="field-has-error"></form:errors>
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="email" class="form-control" placeholder="邮箱"/><br/>
